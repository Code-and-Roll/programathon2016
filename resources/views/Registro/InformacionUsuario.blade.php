  <div class="box box-info">
            ...
            <div class="box-body" >
               <div class="input-group">
                  ...
                  <input type="text" id="nombreCompleto" name="nombreCompleto" class="form-control" placeholder="Nombre completo" maxlength="50" required="Debe ingresar su nombre completo para continuar">
                </div>
                <br>

                <div class="input-group">
                    <label for="nombreUsuario">Nombre de usuario</label>
                  <input type="text" id="nombreUsuario" name="nombreUsuario" class="form-control" placeholder="Nombre de usuario" maxlength="50">
                </div>
                <br>

                <div class="input-group">
                    <label for="password">Contraseña</label>
                  <input type="password" id="password" name="password" class="form-control" placeholder="Contraseña" maxlength="10" minlength="8">
                </div>
                <br>
